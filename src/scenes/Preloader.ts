...
export class Preloader extends Phaser.Scene {
    ...
    preload() {
        ...
        this.text1 = this.add.text(this.sys.canvas.width / 2, 100, 'GIANA', { fontSize: '24px', fill: '#FF0' });
        this.text2 = this.add.text(this.sys.canvas.width / 2, 130, 'GET   READY', { fontSize: '24px', fill: '#FF0' });
        this.text3 = this.add.text(this.sys.canvas.width / 2, 160, 'STAGE 01', { fontSize: '24px', fill: '#FF0' });
        ...
        // this.load.spritesheet('dude', './assets/src/sheet1/metalslug.png',
        // { frameWidth: 38, frameHeight: 45});
